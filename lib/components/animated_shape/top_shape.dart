...
class TopShape extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.cubicTo(
      ...
      Tween<double>(
        begin: 0,
        end: size.height * 0.6650717703349283,
      ).animate(_controller).value,
    );
    ...
    path.cubicTo(
      ...
      Tween<double>(
        begin: 0,
        end: size.height * 0.41626794258372306,
      ).animate(_controller).value,
      size.width * 0.6423076923076924,
      Tween<double>(
        begin: 0,
        end: size.height * 0.5933014354066986,
      ).animate(_controller).value,
    );
    ...
    path.cubicTo(
      ...
      Tween<double>(
        begin: 0,
        end: size.height * 0.8703349282296651,
      ).animate(_controller).value,
    ...
    path.cubicTo(
      ...
      Tween<double>(
        begin: 0,
        end: size.height * 0.6220095693779905,
      ).animate(_controller).value,
      size.width,
      Tween<double>(
        begin: 0,
